	...
	root := r.Group("/", rootMw()...)
	{
		_api := root.Group("/api", _apiMw()...)
		{
			_v1 := _api.Group("/v1", _v1Mw()...)
			{
				...
				_brands.POST("/admins", append(_createbrandadminMw(), admin.CreateBrandAdmin)...)
				...
				_brand_id.GET("/admins", append(_getbrandadminsMw(), admin.GetBrandAdmins)...)
				...
				_admin.GET("/info", append(_getadmininfoMw(), admin.GetAdminInfo)...)
				...
				_admin.GET("/stores", append(_getstorelistMw(), admin.GetStoreList)...)
				_stores := _admin.Group("/stores", _storesMw()...)
				_stores.POST("/admins", append(_createstoreadminMw(), admin.CreateStoreAdmin)...)
				_stores.DELETE("/:store_id", append(_deletestoreMw(), admin.DeleteStore)...)
				_stores.GET("/:store_id", append(_getstoredetailMw(), admin.GetStoreDetail)...)
				_stores.PUT("/:store_id", append(_updatestoreMw(), admin.UpdateStore)...)
				_admin.POST("/stores", append(_createstoreMw(), admin.CreateStore)...)
				...
				{
					_brand_admins := _admin.Group("/brand-admins", _brand_adminsMw()...)
					_brand_admins.DELETE("/:role_id", append(_deletebrandadminMw(), admin.DeleteBrandAdmin)...)
					_role_id := _brand_admins.Group("/:role_id", _role_idMw()...)
					_role_id.PUT("/status", append(_updatebrandadminstatusMw(), admin.UpdateBrandAdminStatus)...)
				}
				{
